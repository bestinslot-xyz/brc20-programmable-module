...
mod tests {
    ...
    fn test_get_tx_details_decode_returns_single_vin_vout() {
        std::env::var("BITCOIN_RPC_URL").unwrap_or_else(|_| {
            panic!("Please set the BITCOIN_RPC_URL environment variable")
        });
        std::env::var("BITCOIN_RPC_USER").unwrap_or_else(|_| {
            panic!("Please set the BITCOIN_RPC_USERNAME environment variable")
        });
        std::env::var("BITCOIN_RPC_PASSWORD").unwrap_or_else(|_| {
            panic!("Please set the BITCOIN_RPC_PASSWORD environment variable")
        });
        ...
        assert_eq!(vin_txids[0], "3fc5d49bad92a1bc10c9b0981f13c47600af871ddc9bac15d22d2c05b6ae80f1");
        assert_eq!(vin_vouts[0], U256::from(0u64));
        assert_eq!(vin_script_pub_key_hexes[0], "5120154a7cbf83a5ad929e224725b915ca5cd7ca7719a9ba2af90945a74e3431934d");
        assert_eq!(vin_values[0], U256::from(487u64));

        assert_eq!(vout_script_pub_key_hexes[0], "5120fcdc5a7bd66b4d3a8c91f1a1cf94ad7d561f3a304bf18faf5678b1ee47e783b7");
