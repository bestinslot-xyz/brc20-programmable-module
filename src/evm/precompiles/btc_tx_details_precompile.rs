...
mod tests {
    ...
    fn test_get_tx_details_decode_returns_single_vin_vout() {
        std::env::var("BITCOIN_RPC_URL")
            .unwrap_or_else(|_| panic!("Please set the BITCOIN_RPC_URL environment variable"));
        std::env::var("BITCOIN_RPC_USER")
            .unwrap_or_else(|_| panic!("Please set the BITCOIN_RPC_USERNAME environment variable"));
        std::env::var("BITCOIN_RPC_PASSWORD")
            .unwrap_or_else(|_| panic!("Please set the BITCOIN_RPC_PASSWORD environment variable"));
